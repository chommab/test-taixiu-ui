window.__require = function e(t, n, r) {
  ...
  coinAction: [ function(require, module, exports) {
    ...
    var coinAction = cc.Class({
      ...
      taiClearCoin: function taiClearCoin(coinmove1, defaultSprCoin1, taiNodestop, arrayTaiNode) {
        var _this = this;
        var posx = this.resultBetTaiXiu(-200, 150);
        var posy = this.resultBetTaiXiu(-100, 100);
      ...
      xiuClearCoin: function xiuClearCoin(coinmove1, defaultSprCoin1, xiaNodestop, arrayXuiNode) {
        var _this2 = this;
  ...
  game: [ function(require, module, exports) {
    ...
    "use strict";
    var AudioManager = require("audio-manager"), coinAction = require("coinAction"), shakeCub = require("shakeCub"), coinSwitch = require("coinSwitch"), coinLight = require("coinSwitchlight"), resultCubBet = require("resultCubBet"), normalCoin = require("normalCoin"), coinStyle = require("coinStyle");
    cc.Class({
      extends: cc.Component,
      properties: {
        coin1: {
      ...
      timeToBet: function timeToBet() {
        ...
        this.schedule(function() {
          ...
          this.timecount < 0 && this.timecount > -5 && AudioManager.instance.playDiceSound();
          if (-7 == this.timecount) {
            this.totalfun();
            this.moveCoin();
      ...
      coin1function: function coin1function() {
        true == this.valuecoin1 && shakeCub.instance.betCoinSwitch(this.coinArray[0], this.coin1, this.defaultSprCoin1);
      },
      coin2function: function coin2function() {
        true == this.valuecoin2 && shakeCub.instance.betCoinSwitch(this.coinArray[1], this.coin2, this.defaultSprCoin2);
      },
      coin3function: function coin3function() {
        true == this.valuecoin3 && shakeCub.instance.betCoinSwitch(this.coinArray[2], this.coin3, this.defaultSprCoin3);
      },
      coin4function: function coin4function() {
        true == this.valuecoin4 && shakeCub.instance.betCoinSwitch(this.coinArray[3], this.coin4, this.defaultSprCoin4);
      },
      coin5function: function coin5function() {
        true == this.valuecoin5 && shakeCub.instance.betCoinSwitch(this.coinArray[4], this.coin5, this.defaultSprCoin5);
      },
      coin6function: function coin6function() {
        true == this.valuecoin6 && shakeCub.instance.betCoinSwitch(this.coinArray[5], this.coin6, this.defaultSprCoin6);
      },
      ...
      allButtonFun: function allButtonFun() {
        ...
        this.taiNode.on(cc.Node.EventType.TOUCH_START, this.taiButton, this);
        this.xiaNode.on(cc.Node.EventType.TOUCH_START, this.XuiButton, this);
      ...
      taiButton: function taiButton() {
        if (this.timecount <= 0) return;
        if (false == this.valuecoin1) {
          AudioManager.instance.playCoinsInsert();
          if (this.valuecretedite >= 1) {
            coinAction.instance.taiClearCoin(this.coinmoveArray[0], this.defaultSprCoin1, this.taiNodestop, this.arrayTaiNode);
        ...
        if (false == this.valuecoin2 && this.valuecretedite >= 5) {
          AudioManager.instance.playCoinsInsert();
          coinAction.instance.taiClearCoin(this.coinmoveArray[1], this.defaultSprCoin2, this.taiNodestop, this.arrayTaiNode);
        ...
        if (false == this.valuecoin3 && this.valuecretedite >= 10) {
          AudioManager.instance.playCoinsInsert();
          coinAction.instance.taiClearCoin(this.coinmoveArray[2], this.defaultSprCoin3, this.taiNodestop, this.arrayTaiNode);
        ...
        if (false == this.valuecoin4 && this.valuecretedite >= 20) {
          AudioManager.instance.playCoinsInsert();
          coinAction.instance.taiClearCoin(this.coinmoveArray[3], this.defaultSprCoin4, this.taiNodestop, this.arrayTaiNode);
        ...
        if (false == this.valuecoin5 && this.valuecretedite >= 50) {
          AudioManager.instance.playCoinsInsert();
          coinAction.instance.taiClearCoin(this.coinmoveArray[4], this.defaultSprCoin5, this.taiNodestop, this.arrayTaiNode);
        ...
        if (false == this.valuecoin6 && this.valuecretedite >= 100) {
          AudioManager;
          AudioManager.instance.playCoinsInsert();
          coinAction.instance.taiClearCoin(this.coinmoveArray[5], this.defaultSprCoin6, this.taiNodestop, this.arrayTaiNode);
      ...
      XuiButton: function XuiButton() {
        if (this.timecount <= 0) return;
        if (false == this.valuecoin1) {
          AudioManager.instance.playCoinsInsert();
          if (this.valuecretedite >= 1) {
            coinAction.instance.xiuClearCoin(this.coinmoveArray[0], this.defaultSprCoin1, this.xiaNodestop, this.arrayXuiNode);
            this.valuecretedite -= 1;
            this.xiuvalue += 1;
        ...
        if (false == this.valuecoin2 && this.valuecretedite >= 5) {
          AudioManager.instance.playCoinsInsert();
          coinAction.instance.xiuClearCoin(this.coinmoveArray[1], this.defaultSprCoin2, this.xiaNodestop, this.arrayXuiNode);
          this.valuecretedite -= 5;
          this.xiuvalue += 5;
          this.xiuLabel.string = this.xiuvalue + "K";
          this.creditLabel.string = this.valuecretedite + "K";
        ...
        if (false == this.valuecoin3 && this.valuecretedite >= 10) {
          AudioManager.instance.playCoinsInsert();
          coinAction.instance.xiuClearCoin(this.coinmoveArray[2], this.defaultSprCoin3, this.xiaNodestop, this.arrayXuiNode);
          this.valuecretedite -= 10;
          this.xiuvalue += 10;
          this.xiuLabel.string = this.xiuvalue + "K";
          this.creditLabel.string = this.valuecretedite + "K";
        ...
        if (false == this.valuecoin4 && this.valuecretedite >= 20) {
          AudioManager.instance.playCoinsInsert();
          coinAction.instance.xiuClearCoin(this.coinmoveArray[3], this.defaultSprCoin4, this.xiaNodestop, this.arrayXuiNode);
          this.valuecretedite -= 20;
          this.xiuvalue += 20;
          this.xiuLabel.string = this.xiuvalue + "K";
          this.creditLabel.string = this.valuecretedite + "K";
        ...
        if (false == this.valuecoin5 && this.valuecretedite >= 50) {
          AudioManager.instance.playCoinsInsert();
          coinAction.instance.xiuClearCoin(this.coinmoveArray[4], this.defaultSprCoin5, this.xiaNodestop, this.arrayXuiNode);
          this.valuecretedite -= 50;
          this.xiuvalue += 50;
          this.xiuLabel.string = this.xiuvalue + "K";
          this.creditLabel.string = this.valuecretedite + "K";
        ...
        if (false == this.valuecoin6 && this.valuecretedite >= 100) {
          AudioManager.instance.playCoinsInsert();
          coinAction.instance.xiuClearCoin(this.coinmoveArray[5], this.defaultSprCoin6, this.xiaNodestop, this.arrayXuiNode);
          this.valuecretedite -= 100;
          this.xiuvalue += 100;
          this.xiuLabel.string = this.xiuvalue + "K";
          this.creditLabel.string = this.valuecretedite + "K";
      ...
      moveCoin: function moveCoin() {
        this.taivalue = 0;
        this.xiuvalue = 0;
        this.taiLabel.string = "0 K";
        this.xiuLabel.string = "0 K";
      },
      refreshScence: function refreshScence() {
        cc.director.loadScene("GameScence");
      },
...
}, {}, [ "audio-manager", "coinAction", "coinStyle", "coinSwitch", "coinSwitchlight", "game", "HotUpdateModule", "LoginView", "normalCoin", "resultCubBet", "shakeCub", "start" ]);